// GENERATED AUTOMATICALLY FROM 'Assets/ControllerActions1.inputactions'
...
public class @ControllerActions1 : IInputActionCollection, IDisposable
{
    public InputActionAsset asset { get; }
    public @ControllerActions1()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""ControllerActions1"",
    ""maps"": [
        {
            ""name"": ""Gameplay"",
    ...
    {
        private @ControllerActions1 m_Wrapper;
        public GameplayActions(@ControllerActions1 wrapper) { m_Wrapper = wrapper; }
